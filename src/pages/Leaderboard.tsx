          ...
          {topThree[1] && (
            <div className="flex flex-col items-center">
              <div className="relative mb-3">
                <img
                  src={
                    topThree[1].avatarUrl || 'https://via.placeholder.com/150'
                  }
          ...
          {topThree[0] && (
            <div className="flex flex-col items-center z-10">
              ...
              <div className="relative mb-3">
                <img
                  src={
                    topThree[0].avatarUrl || 'https://via.placeholder.com/150'
                  }
          ...
          {topThree[2] && (
            <div className="flex flex-col items-center">
              <div className="relative mb-3">
                <img
                  src={
                    topThree[2].avatarUrl || 'https://via.placeholder.com/150'
                  }
      ...
      >
        ...
        >
          {theRest.map((leader: any, index: number) => {
            const rank = index + 4;
            const isMe = user && leader._id === user.id;
            ...
            return (
              ...
              >
                ...
                <div className="col-span-7 flex items-center gap-3">
                  <img
                    src={leader.avatarUrl || 'https://via.placeholder.com/40'}
        ...
        {myRank && myRank.rank > 20 && (
          ...
          >
            ...
            <div className="col-span-7 flex items-center gap-3">
              <img
                src={myRank.user.avatarUrl || 'https://via.placeholder.com/40'}
